...
namespace FlowOps.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251225222947_AddUserUiState")]
    partial class AddUserUiState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlowOps.Infrastructure.Persistence.Entities.SubscriptionDraft", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FlowOps.Infrastructure.Persistence.Entities.UserListCacheEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "CacheKey")
                        .IsUnique();

                    b.ToTable("UserListCaches", (string)null);
                });

            modelBuilder.Entity("FlowOps.Infrastructure.Persistence.Entities.UserPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
